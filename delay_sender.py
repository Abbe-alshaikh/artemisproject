...
try:
    ...
    while True:  # Repeat every 10 minutes
        ...
        print(f"Transmission delay: {end_time - start_time} seconds")  #Calculate and print the delay
        ...
        while True:
            ...
            if eot_signal in bytes_data:  # End-of-transmission signal
                ...
                break
        end_time = time.time()  # Mark the end time
        print(f"Reception delay: {end_time - start_time} seconds")  #Calculate and print the delay
